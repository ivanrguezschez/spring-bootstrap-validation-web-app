...
<html lang="es">
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
         <title><fmt:message key="title.springbootstrapvalidationwebapp"/></title>
        ...
        <link href="${cssPath}springbootstrapvalidationwebapp.css" rel="stylesheet">
        ...
        <script type="text/javascript" src="${jsPath}springbootstrapvalidationwebapp.js"></script>
    </head>
    <body>
        <div class="container">
